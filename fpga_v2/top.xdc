...
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { ready  }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { store  }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
...
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { sclk_async }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { mosi_async }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { is_rom_async }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
